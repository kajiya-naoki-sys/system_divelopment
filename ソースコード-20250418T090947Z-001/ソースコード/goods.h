...
#define GOODS_DSP_LEND_NUM_NUM		5				/* 貸出回数 */
...
#define GOODS_DSP_LEND_NUM_COL		8				/* 貸出回数 */
...
#define GOODS_DSP_LEND_STS_NAME		"状況"			/* 貸出状況 */
#define GOODS_DSP_KEEP_NAME			"場所"			/* 保管場所 */
#define GOODS_DSP_LEND_NUM_NAME		"貸出回数"		/* 貸出回数 */

/* 商品情報マスタファイル */
#define GOODS_FILE_NAME			"goodsMST.dat"		/* 商品情報マスタファイル名 */
#define GOODS_REG_MAX			10000				/* 商品最大登録数 */
#define GOODS_NUMBER_MAX		99999				/* 貸出回数の最大値 */

/* 商品情報マスタファイル：項目名（全角で5文字以内） */
...
/* 商品情報マスタファイル：商品情報の各桁数（構造体メンバーの大きさ） */
